...
def _parse(t):
    ...
    if m_gen:
        ...
        if tag in ("bs","clear","status","research","job","free","git","project","resume","approve_decision","reject_decision","bake","emergency","notfall","diagnose","help","hilfe","confirmations","spass", "worker", "workers"):
