...
def _parse(t):
    ...
    if m_gen:
        ...
        if tag in ("bs","clear","status","research","job","git","project","diagnose","help","spass","worker","merken","allclear000","queue","free","workflow"):
    ...
    if tag in ("bs","clear","status","research","job","git","project","diagnose","help","spass","worker","merken","allclear000","blockade","blokade","queue","free","workflow"):
