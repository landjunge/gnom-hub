...
for r in [memory_router, agents_router, nudge_router, registry_router, chat_router, audio_router, admin_router, ideas_router, workspace_router, llm_router, showbox_router]:
