...
# 1. Rename src/gnom_hub to src/gnom_hub
...
# 2. Rename files inside src/gnom_hub
file_map = {
...
# 3. Replace content in all text files
text_files = []
...
# Apply strictly in order of length (longest first to avoid partial replacements)
