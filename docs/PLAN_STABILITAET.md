...
| S4.3 | CI-Ignore-Liste schrumpfen (nur echte Live-Tests draußen) | weniger blinde Flecken | ✅ +permissions_repo, routing, security_suite, agent_names_frozen; Browser/Preset/Stress draußen |
